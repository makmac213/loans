...
class Migration(SchemaMigration):
    ...
    def forwards(self, orm):
        ...
        # Adding field 'Engagement.offer_reference'
        db.add_column('odesk_engagements', 'offer_reference',
    ...
    def backwards(self, orm):
        ...
        # Deleting field 'Engagement.offer_reference'
        db.delete_column('odesk_engagements', 'offer_reference')
